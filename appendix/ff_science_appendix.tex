...
% subsection - Sheridan drive efficiency
\newpage
...
% creating linear approximation (ONE LEVEL OFF)
...
% cruise time as function of distance (ONE LEVEL OFF)
...
% derivative of v(x0) (ONE LEVEL OFF)
...
% final expression for approximation (ONE LEVEL OFF)
